riot.tag2('todo', '<div class="container"> <div class="panel panel-primary chat-bg" style="align-items:center; justify-content:center;"> <div class="panel-heading"> <h3 class="panel-title">TODO List</h3> </div> <div class="list-group"> <div each="{todos}" class="list-group-item" key="{id}"> <div class="pull-right"> <button class="btn btn-xs btn-danger" onclick="{parent.removeTodo}"> Delete </button> </div> {name} </div> <div class="list-group-item"> <form id="todo-form" name="todo-form" class="list-group-item" onsubmit="{createTodo}"> <input text="form-control" type="text" name="todoInput" onkeyup="{edit}" placeholder="Enter a message and press enter"> </form> </div> </div> </div> </div>', '', '', function(opts) {
